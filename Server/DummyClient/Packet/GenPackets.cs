...
public class S_BroadcastEnterGame : IPacket
{
    ...
    public void Read(ArraySegment<byte> segment) // 역직렬화
    {
        ushort count = 0;
        ...
        //범위를 초과하는 값을 파싱을 시도할때 에러가 나면서 익셉션이 발생
    ...
    public ArraySegment<byte> Write() // 직렬화
    {
        ArraySegment<byte> segment = SendBufferHelper.Open(4096); //TLS영역에 아래 값을 삽입
